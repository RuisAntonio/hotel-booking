...
Stay Booker Pro is a production-ready hotel booking website built with modern web technologies. It is designed to be a fully functional and responsive web application for hotel booking services. For the backend api checkout: [staybooker-express-api](https://github.com/RuisAntonio/hotel-booking)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/RuisAntonio/hotel-booking
   ```
